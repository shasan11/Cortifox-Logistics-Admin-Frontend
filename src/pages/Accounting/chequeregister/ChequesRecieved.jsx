  ...
  return (
    ...
    >
      <Form layout="vertical">
        ...
        <Form.Item label="Payee Name" required>
          <Input
           size="large"
            id="payee_name"
            name="payee_name"
          ...
          {formik.touched.payee_name && formik.errors.payee_name && (
            <div className="text-danger">{formik.errors.payee_name}</div>
          )}
        </Form.Item>
        ...
        <Form.Item label="Issued Date" required>
          <Input
           size="large"
            type="date"
            id="issued_date"
...
const ChequeRecieved = () => {
  ...
  const forTitle = "Cheque Recieved";
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      <SingleTonCrud
        ...
        filterurl="?cheque_type=recieved&"
