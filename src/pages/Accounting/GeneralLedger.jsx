...
const GeneralLedgerModal = ({
    ...
    return (
      <Modal title={modalTitle} visible={visible} onClose={onCancel} onCancel={onCancel} onOk={formik.handleSubmit} destroyOnClose={true} footer={[ <Button key="back" onClick={onCancel}> Cancel </Button>, <Button key="submit" className="green-button" type="primary" onClick={formik.handleSubmit}> Submit </Button>, ]} >
